...
class CSWGeometadataiHarvester(SpatialHarvester, SingletonPlugin):
    '''
    ...
    def info(self):
        return {
            'name': 'csw',
            'title': 'CSW Server Geometadatai',
            'description': 'Geometadatai rasmotājs Catalog Service standardam'
            }
    ...
    def get_original_url(self, harvest_object_id):
        ...
        log.debug('CSW target URL: %s', url)
        return url
    ...
    def gather_stage(self, harvest_job):
        ...
        log.debug('CSWGeometadataiHarvester gather_stage for job: %r', harvest_job)
        # Get source URL
        ...
        try:
            ...
            self._save_gather_error('Error contacting the CSW server22222: %s' % e, harvest_job)
            return None
    ...
    def fetch_stage(self,harvest_object):
        ...
        log.debug('CSWGeometadataiHarvester fetch_stage for object: %s', harvest_object.id)
        ...
        #log.debug('XML content: %s', record['xml'])
        return True
